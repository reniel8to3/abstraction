...
fan_2.color_setter()
fan_2.power_setter()
print('The speed of Fan 2 is ' ,fan_2.fan_speed_getter(), ' and its radius is ' ,fan_2.radius_getter(), ' while the fan is ' ,fan_2.color_getter(), ' and its is ' ,fan_2.power_getter(), '.')